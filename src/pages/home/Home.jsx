                    ...
                    {Data.map(({ img, id }, index) => (
                        <div key={id} className='grid__item' onClick={() => openPreview(img, index)}>
                            <LazyLoadImage
                                ...
                                // Provide fallback for browsers that don't support WebP
                                fallbackImage={`${img}?w=300&format=jpg`}
                                wrapperClassName="lazy-load-image-background lazy-load-image-loaded"
